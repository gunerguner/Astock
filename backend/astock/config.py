...
MARKET_CAP_THRESHOLD = int(_business.get("market_cap_threshold", 100_000_000_000))
...
# api
TENCENT_QUOTE_URL = str(_tencent.get("quote_url", "http://qt.gtimg.cn/q="))
